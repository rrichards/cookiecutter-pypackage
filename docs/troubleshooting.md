...
> **Note:** Can you help improve this file? [Edit this file](https://github.com/rrichards/cookiecutter-pypackage/blob/master/docs/troubleshooting.md) and submit a pull request with your improvements!
