...
> **Note:** Did you find any of these instructions confusing? [Edit this file](https://github.com/rrichards/cookiecutter-pypackage/blob/master/docs/tutorial.md) and submit a pull request with your improvements!
