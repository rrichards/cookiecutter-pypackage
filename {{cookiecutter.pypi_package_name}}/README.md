...
This package was created with [Cookiecutter](https://github.com/rrichards/cookiecutter) and the [rrichards/cookiecutter-pypackage](https://github.com/rrichards/cookiecutter-pypackage) project template.
